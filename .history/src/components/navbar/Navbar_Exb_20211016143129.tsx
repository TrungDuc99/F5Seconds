    ...
    <NavBarWrapper elevation={2} hoverEffect={false}>
      <InnerContainer sx={{ justifyContent: 'flex-center' }}>
        ...
        {/* <BazarImage
          ...
          src="/assets/images/exbImage/imageIcons/icon-langue-vn.png"
          alt="hinh-langue"
        ></BazarImage> */}
        <Button
          style={{ marginRight:'10px' borderRadius: '55px', backgroundColor: '#fff', color: '#005F92' }}
        >
          <SearchIcon></SearchIcon>
        </Button>
        <Button
          style={{ borderRadius: '55px', backgroundColor: '#fff', color: '#005F92' }}
        >
          <MenuIcon></MenuIcon>
        </Button>
      </InnerContainer>
